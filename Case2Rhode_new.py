...
st.text('De beroepsklasse Openbaar bestuur, veiligheid en justitie bevat onder andere beveiligingswerkers zoals politie, brandweer en militaire beroepen. Deze beroepen krijgen over het algemeen vaker te maken met geweld (en vuur), wat meer risico op gewond raken met zich meebrengt. Dit zou een reden kunnen zijn dat het percentage hoog ligt.')
st.text('Het hoge percentage bij de beroepsklasse Zorg en welzijn beroepen zou kunnen komen door een hogere kans op besmetting en eventuele fysieke en mentale werkdruk.')
st.text('')
st.text('Het is ook opvallend dat de beroepsklasse Managers (mediaan: 2,7%) vrij laag ligt, gevolgd door de beroepsklasse ICT beroepen (mediaan: 3,2%) die iets hoger ligt.')
st.text('Het lage percentage bij Managers doet vermoeden dat managers vaker doorwerken bij ziekte, of zich in ieder geval niet ziek melden. Dit blijkt ook uit cijfers van het Sociaal Cultureel Planbureau (https://mtsprout.nl/management-leiderschap/mt-onderzoek-zieke-manager-werkt-altijd-door).')
st.text('Bij de beroepsklasse ICT beroepen is het aannemelijk dat het voor werknemers makkelijker is om thuis door te werken als op kantoor werken niet mogelijk is. Dit zou dan ook de reden kunnen zijn van het lage ziekteverzuimpercentage (maar dit is slechts een aanname).')
st.text('')
st.text('Spreiding')
st.text('De spreiding van Beroepsklasse overig valt het meeste op. De spreiding van deze klasse is waarschijnlijk te verklaren door de verschillende beroepen die hierin vallen. Deze beroepen zijn niet gespecificeerd in de dataset, maar het is aannemelijk dat deze beroepen aardig verschillen van elkaar en daardoor ook verschillende ziekteverzuimpercentages hebben.')
st.text('')
st.text('De beroepsklasse Creatieve en taalkundige beroepen heeft ook een redelijk grote spreiding. De verwachting is dat dit komt door het brede spectrum aan beroepen binnen die beroepsklasse. Ook deze beroepen zijn niet gespecificeerd in de dataset, maar de beroepssegmenten die hieronder vallen wel: Auteurs en kunstenaars en Vakspecialisten op artistiek en cultureel gebied.')
st.text('')
st.text('De kleine spreiding van de Pedagogische beroepen valt ook op. Dit heeft waarschijnlijk als reden het tegenovergestelde van het bovengenoemde. De beroepssegmenten die onder deze klasse vallen zijn: Docenten, Sportinstructeurs en Leidsters kinderopvang en onderwijs. Het beroepssegment Sportinstructeurs verschilt qua werkzaamheden van de andere twee beroepssegmenten - je zou dus eigenlijk niet zo’n kleine spreiding verwachten – maar dit segment bevat geen data over het ziekteverzuimpercentage en doet dus niet mee in de boxplot.')
